...
const ImageWithFallback = ({
  ...
  return (
    <div className="relative">
      {loading && (
        <div
          className={`${className} bg-white/10 flex items-center justify-center absolute inset-0 z-10`}
        >
...
export default function AdminPage() {
  ...
  const [activeSection, setActiveSection] = useState<AdminSectionType>("posts");
  ...
  const showConfirm = (postId: string, action: ActionType) => {
    const configs = {
      approve: {
        ...
        message:
          "Bài viết sẽ được hiển thị công khai trên mạng xã hội. Bạn có chắc chắn?",
      },
      reject: {
        title: "Hủy duyệt bài viết",
        message:
          "Bài viết sẽ bị gỡ khỏi mạng xã hội và chuyển về trạng thái chờ duyệt.",
      },
      delete: {
        title: "Xóa bài viết",
        message:
    ...
    try {
      switch (action) {
        case "approve":
          ...
          setToast({
            message: "Đã phê duyệt bài viết thành công!",
            type: "success",
          });
          break;
                      ...
                      <div className="flex flex-col items-center justify-center py-16 text-center px-4">
                        {searchQuery ? (
                          ...
                          <>
                            ...
                            <p className="text-slate-500 text-sm">
                              Các bài viết đã duyệt sẽ hiển thị ở đây
                            </p>
                          </>
                        )}
                      </div>
                                ...
                                {post.userOfPostResponse?.urlAvatar ? (
                                  ...
                                  <div className="w-11 h-11 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center ring-2 ring-white/10">
                                    <span className="text-white font-semibold">
                                      {post.userOfPostResponse?.name?.charAt(
                                        0
                                      ) || "U"}
                                    </span>
                                  </div>
                    ...
                    {selectedPost ? (
                      <div className="flex flex-col h-[calc(100vh-300px)]">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
                          ...
                          <div className="flex items-center gap-4 mb-6 pb-6 border-b border-white/10">
                            {selectedPost.userOfPostResponse?.urlAvatar ? (
                              ...
                              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center ring-2 ring-white/10">
                                <span className="text-white font-bold text-lg">
                                  {selectedPost.userOfPostResponse?.name?.charAt(
                                    0
                                  ) || "U"}
                                </span>
                              </div>
                            ...
                            <div>
                              <p className="font-semibold text-white text-lg">
                                {selectedPost.userOfPostResponse?.name ||
                                  "Unknown User"}
                              </p>
                          ...
                          {/* Transactions */}
                          {selectedPost.snapshotResponse?.[0]
                            ?.transactionOfPosts && (
                            <div className="mb-6">
                              ...
                              <div className="bg-white/5 rounded-xl border border-white/5 overflow-hidden">
                                <table className="w-full text-sm">
                                  ...
                                  <tbody className="divide-y divide-white/5">
                                    {selectedPost.snapshotResponse[0].transactionOfPosts.map(
                                      (t, i) => (
                                        <tr
                                          key={i}
                          ...
                          {selectedPost.snapshotResponse?.[0]
                            ...
                            <div className="mb-6">
                              ...
                              <div className="grid gap-3">
                                {selectedPost.snapshotResponse[0].investmentAssetOfPosts.map(
                                  (asset, i) => (
                                    <div
                                      key={i}
                                      ...
                                      <div className="text-right">
                                        ...
                                        >
                                          {asset.priceChangePercentage24h >= 0
                                            ? "+"
                                            : ""}
                                          {asset.priceChangePercentage24h.toFixed(
                                            2
                                          )}
                                          %
                                        </p>
                        ...
                        <div className="shrink-0 p-4 sm:p-6 border-t border-white/10 bg-[#0D1B2A] rounded-b-2xl">
                          ...
                          !selectedPost.isApproved ? (
                            <div className="grid grid-cols-2 gap-3">
                              <button
                                onClick={() =>
                                  showConfirm(selectedPost.idPost, "approve")
                                }
                              ...
                              <button
                                onClick={() =>
                                  showConfirm(selectedPost.idPost, "delete")
                                }
                                disabled={actionLoading === selectedPost.idPost}
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <button
                                onClick={() =>
                                  showConfirm(selectedPost.idPost, "reject")
                                }
                                disabled={actionLoading === selectedPost.idPost}
                      ...
                      <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <p className="text-slate-500 text-sm max-w-xs">
                          Click vào bài viết bên trái để xem chi tiết và thực
                          hiện thao tác
                        </p>
                      </div>
                    )}

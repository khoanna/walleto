    ...
    return (
        <div className="relative flex flex-col items-center justify-center text-center bg-[#050F24]">
            ...
            <div className="absolute top-0 left-0 z-20 w-full flex items-center justify-between px-8 py-5">
                ...
                <div onClick={() => router.push("/auth")} className="bg-black/40 hover:bg-black/70 cursor-pointer text-white px-4 py-1.5 rounded-full border border-white/10 transition">
                    Đăng nhập
                </div>
            </div>
            ...
            <div className="px-4 mt-50 flex flex-col items-center justify-center z-20">
                ...
                <button onClick={() => router.push("/auth")} className="cursor-pointer bg-black text-white text-sm px-6 py-2 rounded-full shadow-md hover:bg-white hover:text-black transition duration-300">
                    Tạo tài khoản
                </button>
